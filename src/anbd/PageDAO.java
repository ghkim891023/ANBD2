...
public class PageDAO extends DbInfo{
	...
	public void selMainListNoDone( ArrayList<AnbdVO> mainList, int startRow, int pageSize, HttpServletRequest request) {
...
//			mKey=""; }
		...
		try {
			...
			System.out.println("selMainListNoDone SQL: "+SQL);
			executeQuery();
			rs.next();
			count = Integer.parseInt(rs.getString("count"));
			System.out.println("총 게시글 수: "+count);
		} catch (Exception e) {
			System.out.println("selMainListNoDone count(*) 에러: "+e.getMessage());
			e.printStackTrace();
		}
		rsClose();
		pstateClose();
		...
		try {
			...
			System.out.println("selMainListNoDone 에러: "+e.getMessage()); 
		}
		rsClose();
		pstateClose();
		conClose();
	...
	public void selMainListJuso( ArrayList<AnbdVO> mainList, int startRow, int pageSize, HttpServletRequest request, Integer jusoNo) {
		String menu = request.getParameter("menu");
		String pMenu =""; //검색용
		if(menu==null || menu.equals("") ){   //메인은 menu가 null
			pMenu="";
...
//		}
	...
	public void selMainList2noDone( ArrayList<AnbdVO> mainList, int startRow, int pageSize, HttpServletRequest request, boolean noDone) {
		String menu = request.getParameter("menu");
		String pMenu =""; //검색용
		if(menu==null || menu.equals("") ){   //메인은 menu가 null
			pMenu="";
