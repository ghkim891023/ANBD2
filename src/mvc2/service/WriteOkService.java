...
public class WriteOkService extends DbInfo{
	...
	public boolean registArticle(BoardVO boardVo, HttpServletRequest request, int userNo) throws Exception{
		...
		boolean inWrite = dao.inWriteMVC2(boardVo, request, userNo);
